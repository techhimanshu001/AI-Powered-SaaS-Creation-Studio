...
const Blocktitle = () => {
  ...
  const blogCategories =['General', 'Technology', 'Health', 'Lifestyle' , 'Eduction', 'Travel', 'Food']
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' >
      <div className=' flex items-center gap-3'>
        <Sparkles className=' w-6 text-[#680daa]' />
      ...
      <br />
      <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#9e18f1] to-[#6e0391] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
    ...
    <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
      ...
      <div className='flex items-center gap-3'>
        <Hash className='w-5 h-5 text-[#64059b]' />
