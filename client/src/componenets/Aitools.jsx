  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
     <div className='text-center'>
        <h2 className='text-slate-700 text-[42px] front-semibold'>powerful Ai tools</h2>
        <p className='text-gray-500 wax-w-lg mx-auto'>A powerful AI tool designed to help you create faster, think smarter, and do more — effortlessly </p>
        </div> 
